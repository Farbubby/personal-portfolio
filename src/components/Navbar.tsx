...
function Navbar() {
  ...
  let navButton =
    " hover:text-white px-3 py-1 rounded-xl duration-200 font-bold text-lg";

  let arrange = mobile ? " justify-evenly" : " gap-8 justify-end";
  ...
  return (
    <>
      <div
        className={
          "flex flex-row px-4 h-16 fixed w-full bg-gray-950 z-10 text-blue-400 items-center" +
          moveNavBar +
          arrange
        }>

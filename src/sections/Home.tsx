  ...
  return (
    <div
      ...
      <div
        ...
        <div className={"flex flex-col text-5xl md:text-6xl gap-8"}>
          <p className={"py-2 animate-down opacity-0" + sublime}>Welcome!</p>
          <div className="animate-up opacity-0">
            <p className={"md:text-2xl text-xl" + sublime}>My name is</p>
            <p className={"md:text-2xl text-xl" + sublime}>Farhan Mahbub</p>
          </div>
        </div>
        <img
          src="/bubby.png"
